...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///home/galoistom/.local/share/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///home/galoistom/.local/share/qutebrowser/userscripts/*')
...
c.fonts.default_family = 'CascadiaMono'
...
# Type: Font
c.fonts.tabs.selected = 'CascadiaMono'
# 设置网页的标准字体（通常是 Wikipedia 使用的无衬线字体）
c.fonts.web.family.standard = "CascadiaMono"  # 换成你喜欢的字体
c.fonts.web.family.sans_serif = "CascadiaMono"
c.fonts.web.family.serif = "CascadiaMono"
# Font used for unselected tabs.
# Type: Font
c.fonts.tabs.unselected = 'CascadiaMono'
...
# 设置调用脚本的命令
# {} 会被 qutebrowser 自动替换为一个存放结果的临时文件路径
